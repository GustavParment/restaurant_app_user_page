  ...
  return (
    <div className="flex flex-col h-screen bg-gray-100">
      ...
      <header className="p-4 bg-purple-950 bg-gradient-to-t from-red-400 text-white text-lg font-bold shadow-md">
        ...
        <img src="/images/alexander.jpg" alt="" className="h-10 w-10 rounded-full" />
         <p className="px-10"> Chat with<span>"USER_NAME"</span></p> {/**Hämta username här  */}
        </div>
      </header>
      ...
      <div className="sticky bottom-0 p-4 bg-white shadow-md">
        <div className="flex items-center space-x-3">
          ...
          <button
            onClick={sendMessage}
            className="px-4 py-2 bg-purple-950 bg-gradient-to-t from-red-400 text-white rounded-lg hover:bg-gray-400"
          >
            Send
          </button>
        </div>
